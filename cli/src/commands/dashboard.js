...
// ══════════════════════════════════════════════════════════════════════════════
//  HEADER — printed once, large enough to show mascot fully
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
//  MAIN — Simple readline. NO alternate screen. NO raw mode. Just works.
// ══════════════════════════════════════════════════════════════════════════════
...
export async function runDashboard() {
  ...
  // Simple readline loop — inquirer handles its own stdin when called
  ...
  rl.on("line", async (line) => {
    ...
    // CRITICAL: pause readline before any inquirer call
    rl.pause();

    try {
      if (input === "/") {
        // Slash menu — show command list
      ...
      // Inquirer can throw if user force-closes — just continue
