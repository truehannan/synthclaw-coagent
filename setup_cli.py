#!/usr/bin/env python3
"""
Conclave-CoAgent — Interactive Setup CLI
...
def main():
    ...
    print("━" * 50)
    config["CONCLAVE_BASE_DIR"] = ask(
        "Base directory",
        default=existing.get("CONCLAVE_BASE_DIR", "/opt/agent"),
    )
    ...
    lines = [
        "# Conclave-CoAgent Configuration",
    ...
    lines += [
        ...
        "",
        "# Server",
        f'CONCLAVE_BASE_DIR="{config["CONCLAVE_BASE_DIR"]}"',
